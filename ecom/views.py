...
#---------AFTER ENTERING CREDENTIALS, CHECK WHETHER USERNAME AND PASSWORD IS OF ADMIN,CUSTOMER
...
def my_profile_view(request):
    ...
    return render(request, 'ecom/my_profile.html', {'customer': customer, 'profile_pic_url': profile_pic_url})
